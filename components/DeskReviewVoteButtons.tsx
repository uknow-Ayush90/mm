...
import { useDeskReviewVote } from "@/hooks/useDeskReviewVote";
...
export default function DeskReviewVoteButtons({
  reviewId,
  upvotes,
  downvotes,
  score,
  ...
  const { upvotes: u, downvotes: d, score: s, userVote, vote, isLoading } = useDeskReviewVote(reviewId, {
    upvotes,
    downvotes,
    score,
    userVote: initialVote,
